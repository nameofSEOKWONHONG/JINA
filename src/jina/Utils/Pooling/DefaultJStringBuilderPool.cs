...
internal sealed class DefaultJStringBuilderPool : JStringBuilderPool
{
	/// <summary>
	...
	/// </summary>
	internal DefaultJStringBuilderPool()
	...
	internal DefaultJStringBuilderPool(int poolSize)
	...
	internal DefaultJStringBuilderPool(int initialBuilderCapacity, int maxBuilderCapacity)
	...
	/// <param name="maxBuilderCapacity">Maximum capacity of builder.</param>
	/// <param name="poolSize">Maximum number of builders stored in the pool.</param>
	internal DefaultJStringBuilderPool(int initialBuilderCapacity, int maxBuilderCapacity, int poolSize)
	{
